...
namespace SpotifyWeb
{
    ...
    #pragma warning restore CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
        ...
        /// <remarks>
        /// Get a specific artist, specified by their ID.
        /// </remarks>
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<ListOf_artists_AndArtist> GetArtistAsync(string artist_id)
        {
            return GetArtistAsync(artist_id, System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<ListOf_artists_AndArtist> GetArtistAsync(string artist_id, System.Threading.CancellationToken cancellationToken)
        {
            if (artist_id == null)
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<ListOf_artists_AndArtist>(response_, headers_, cancellationToken).ConfigureAwait(false);
                            if (objectResponse_.Object == null)
                            {
                                throw new ApiException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                            }
        ...
        /// <remarks>
        /// Get a list of artists, specified by their IDs.
        /// </remarks>
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<ListOf_artists_AndArtist> GetArtistsAsync(string artists_ids)
        {
            return GetArtistsAsync(artists_ids, System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<ListOf_artists_AndArtist> GetArtistsAsync(string artists_ids, System.Threading.CancellationToken cancellationToken)
        {
            if (artists_ids == null)
                throw new System.ArgumentNullException("artists_ids");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    urlBuilder_.Append("artists");
                    urlBuilder_.Append('?');
                    urlBuilder_.Append(System.Uri.EscapeDataString("artists_ids")).Append('=').Append(System.Uri.EscapeDataString(ConvertToString(artists_ids, System.Globalization.CultureInfo.InvariantCulture))).Append('&');
                    urlBuilder_.Length--;
